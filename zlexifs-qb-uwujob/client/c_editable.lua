...
RegisterNetEvent('zlexif-uwu:client:Eat', function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", Language.Progressbars.Eating..QBCore.Shared.Items[itemName].label.."..", 6000, false, true, {
        ...
        TriggerServerEvent("zlexif-uwu:Server:RemoveItem", itemName, 1)
...
RegisterNetEvent('zlexif-uwu:client:Drink', function(itemName)
...
RegisterNetEvent('zlexif-uwu:client:DrinkAlcahol', function(itemName)
